<footer id="footer">
  <div class="container  d-flex flex-wrap pad-bottom-40">
    <div class="col-12 col-md-4 col-lg-3 pad-left-0">
      <a href="/" class="d-block logo-wrapper pad-bottom-20 pad-bottom-0-m">
    ...
    <div class="col-12 col-md-8 col-lg-9 d-flex flex-column pad-right-0 text-center  text-md-left text-md-row ">
      ...
      <div class=" d-flex social-wrapper justify-content-center justify-content-md-start">
        ...
        <a href="https://www.instagram.com/oasischurchreading/" target="_blank" class="social-icon" aria-label="Visit our instagram page">
    ...
    <nav id="footer-menu" class="">
      <div class="menu-footer-menu-container">
        <ul id="menu-footer-menu" class="menu">
          <li id="menu-item-303" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-303"><a href="/">Home</a></li>
          <li id="menu-item-1046" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1046"><a rel="privacy" href="/privacy">Privacy Policy</a></li>
          <li id="menu-item-0001" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1046"><a href="/accessibility">Accessibility</a></li>
          <li id="menu-item-0002" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1046"><a href="/safeguarding">Safeguarding</a></li>
          <li id="menu-item-1078" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1078"><a href="/donate">Donate</a></li>
        </ul>
      </div>
    </nav>
  </div>
